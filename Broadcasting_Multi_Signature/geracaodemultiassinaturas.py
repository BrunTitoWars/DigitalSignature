...
print("\n======== RESULTADO ========")
print(f"Mensagem: {M}")
print(f"K (produto dos R): {K}")
print(f"Hash l: {l}")
print(f"D (assinatura combinada): {D}")
print(f"K' (verificação): {K_prime}")
print(f"l' (hash verificado): {l_prime}\n")

if l == l_prime:
    print("Assinatura VÁLIDA!")
    print("→ A assinatura é válida porque o hash l gerado durante a assinatura")
    print("  é igual ao hash l' gerado na verificação.")
else:
    print("Assinatura INVÁLIDA!")
    print("→ A assinatura é inválida porque houve divergência entre l e l',")
    print("  indicando alteração ou falha no processo.")
...
plt.text(1, max(R_values + D_values) * 1.1, f'Resultado: Assinatura {resultado}', fontsize=14, ha='center')
